...
const nextConfig = {
  // No output: 'export' for Vercel - enables API routes
  trailingSlash: true,
  images: {
    unoptimized: true
  },
        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://www.google.com https://www.gstatic.com",
